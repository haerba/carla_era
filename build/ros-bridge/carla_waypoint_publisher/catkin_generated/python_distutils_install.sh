...
echo_and_run cd "/home/ics/catkin_ws/src/ros-bridge/carla_waypoint_publisher"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/ics/catkin_ws/build/ros-bridge/carla_waypoint_publisher" \
    install \
    --root="${DESTDIR-/}" \
